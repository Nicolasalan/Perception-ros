...
class LoadFace(object):
    ...
    def camera_callback(self,data):
          ...
          arquivo = cv2.imread('/home/user/catkin_ws/src/opencv_for_robotics_images/Unit_3/Course_images/chris.jpg.')

          imagem_original = cv2.resize(arquivo,(500,300))

          img = cv2.resize(arquivo,(500,300))
